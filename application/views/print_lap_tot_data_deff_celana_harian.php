...
<p style="font-size: 12px; font-weight:bold; text-align:center;" >Laporan Data Deffect Celana Harian<br>PT. Sansan Saudaratex Jaya<hr></p>
									<?php
									$sql= "
SELECT
...
WHERE tanggal between '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC";
									...
									{   $no++;
echo '<table width="900px" style="font-size: 12px; border: 1px solid black;border-width: thin">
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td width="130px">Open Seam at Waistban</td>
      <td width="1px">:</td>
      <td width="180px">'.$row[openseam_at_waistban].' pcs</td>
    ...
    <tr>
      ...
      <td width="130px">Run Up at Waistban</td>
      <td width="1px">:</td>
      <td width="160px">'.$row[runup_at_waistban].' pcs</td>
    ...
    <tr>
      ...
      <td width="1px">:</td>
      <td>'.$row[namaqc].'</td>
      <td>Skip at Inseam</td>
      <td>:</td>
      <td>'.$row[skip_at_inseam].' pcs</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td>'.$row[buyer].'</td>
      <td>Open Seam at Inseam</td>
      <td>:</td>
      <td>'.$row[openseam_at_inseam].' pcs</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td>'.$row[style].'</td>
      <td>Run at Bottom Hem</td>
      <td>:</td>
      <td>'.$row[totaldeffect].' pcs</td>
      <td colspan="3">&nbsp;</td>
    </tr>
  </tbody>
</table>
