...
<div id="dialog-form" class="easyui-dialog" style="width:229px; height:160px; padding: 10px 20px" closed="false" buttons="#dialog-buttons" data-options="title:'Cetak Laporan Celana Harian'">
<form id="form" name="form" action="<?php echo base_url('home/cetak_lap_celana_harian');?>" method="POST" target="_blank" onsubmit="javascript: setTimeout(function(){location.reload();}, 1000);return true;">
<fieldset>
