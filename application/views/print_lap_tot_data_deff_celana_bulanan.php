...
<p style="text-align:center; font-size: 12px; font-weight:bold;"><?php echo assets::img('logo.jpg')?></p>
		...
		<p style="font-size: 12px; font-weight:bold; text-align:center;" >Laporan Data Deffect Celana Bulanan<br>PT. Sansan Saudaratex Jaya<hr></p>
		<p style="font-size: 12px; font-weight:bold; text-align:center;" >Persentasi Deffect Celana SS1</p>
		<div align="center"><img src="<?php echo 'Laporan/graphPage?id=1&d1='.$ini_a.'&d2='.$ini_b.'&d3='.$ini_c.'&d4='.$ini_d.'&d5='.$ini_e.'';?>" ><?php echo Assets::img('legend_def_celana_bulanan.png')?>"</div>
<div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-striped">
									...
									<tr>
										...
										<th style="font-size:10px; border:1px dotted black;"><center>Openseam at Waistban</center></th>
                                    	<th style="font-size:10px; border:1px dotted black;"><center>Run up at Waistban</center></th>
                                    	<th style="font-size:10px; border:1px dotted black;"><center>Openseam at Inseam</center></th>
                                    	<th style="font-size:10px; border:1px dotted black;"><center>&nbsp;Skip at Inseam&nbsp;</center></th>
                                    	<th style="font-size:10px; border:1px dotted black;"><center>Run up at Bottom Hem</center></th>
...
WHERE month(tbl_sewing_qc.tanggal)='$tanggal_awal' ORDER BY tbl_sewing_qc.tanggal ASC";
									...
									{   $no++;
                                        ...
                                        echo '<td style="font-size: 10px; border: 1px dotted black;"><center>'.$row[openseam_at_waistban].'</center></td>';
                                        echo '<td style="font-size: 10px; border: 1px dotted black;"><center>'.$row[runup_at_waistban].'</center></td>';
                                        echo '<td style="font-size: 10px; border: 1px dotted black;"><center>'.$row[openseam_at_inseam].'</center></td>';
                                        echo '<td style="font-size: 10px; border: 1px dotted black;"><center>'.$row[skip_at_inseam].'</center></td>';
										echo '<td style="font-size: 10px; border: 1px dotted black;"><center>'.$row[runup_at_bottomhem].'</center></td>';
