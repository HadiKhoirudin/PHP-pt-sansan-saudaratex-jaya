...
<p style="font-size: 12px; font-weight:bold; text-align:center;" >Laporan Data Total Kemeja Bulanan<br>PT. Sansan Saudaratex Jaya<hr></p>
...
INNER JOIN tbl_deffect_kemeja ON tbl_deffect_kemeja.kodegarment = tbl_sewing_qc.kodegarment
WHERE month(tbl_sewing_qc.tanggal)='$tgl' ORDER BY tbl_sewing_qc.tanggal ASC";
									$query = $db->query($sql);
