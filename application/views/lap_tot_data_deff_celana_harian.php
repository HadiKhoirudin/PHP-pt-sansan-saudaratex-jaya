...
<div id="dialog-form" class="easyui-dialog" style="width:300px; height:200px; padding: 10px 20px" closed="false" buttons="#dialog-buttons" data-options="title:'Cetak Laporan Total Data Deffect Celana Harian'">
<form id="form" name="form" action="<?php echo base_url('home/cetak_lap_tot_data_deff_celana_harian');?>" method="POST" target="_blank" onsubmit="javascript: setTimeout(function(){location.reload();}, 1000);return true;">
<fieldset>
